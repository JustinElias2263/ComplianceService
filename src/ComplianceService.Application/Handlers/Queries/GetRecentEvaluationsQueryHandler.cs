...
/// <summary>
/// Handler for getting recent compliance evaluations across all applications
/// </summary>
public class GetRecentEvaluationsQueryHandler : IRequestHandler<GetRecentEvaluationsQuery, Result<IReadOnlyList<ComplianceEvaluationDto>>>
{
    private readonly IComplianceEvaluationRepository _evaluationRepository;
    private readonly IApplicationRepository _applicationRepository;

    public GetRecentEvaluationsQueryHandler(
    ...
    public async Task<Result<IReadOnlyList<ComplianceEvaluationDto>>> Handle(
        GetRecentEvaluationsQuery request,
        CancellationToken cancellationToken)
    {
        var evaluations = await _evaluationRepository.GetRecentAsync(request.Days, cancellationToken);
