...
/// </summary>
public class GetComplianceEvaluationByIdQueryHandler : IRequestHandler<GetComplianceEvaluationByIdQuery, Result<ComplianceEvaluationDto>>
{
    private readonly IComplianceEvaluationRepository _evaluationRepository;
    private readonly IApplicationRepository _applicationRepository;

    public GetComplianceEvaluationByIdQueryHandler(
    ...
    public async Task<Result<ComplianceEvaluationDto>> Handle(GetComplianceEvaluationByIdQuery request, CancellationToken cancellationToken)
    {
