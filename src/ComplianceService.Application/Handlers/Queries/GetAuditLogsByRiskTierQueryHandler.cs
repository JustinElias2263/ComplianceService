...
/// <summary>
/// Handler for getting audit logs by risk tier
/// </summary>
public class GetAuditLogsByRiskTierQueryHandler : IRequestHandler<GetAuditLogsByRiskTierQuery, Result<IReadOnlyList<AuditLogDto>>>
{
    private readonly IAuditLogRepository _auditLogRepository;

    public GetAuditLogsByRiskTierQueryHandler(IAuditLogRepository auditLogRepository)
    {
        _auditLogRepository = auditLogRepository;
    }

    public async Task<Result<IReadOnlyList<AuditLogDto>>> Handle(GetAuditLogsByRiskTierQuery request, CancellationToken cancellationToken)
    {
        var auditLogs = await _auditLogRepository.GetByRiskTierAsync(
            request.RiskTier,
            request.FromDate,
            request.ToDate,
            cancellationToken);
